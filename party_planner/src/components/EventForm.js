...
const EventFormShape = (prop) => {
    ...
    const headerText = editedEvent
        ? `Update Event - ${editedEvent[0].name}`
        : "New Event";
            ...
            <Form selectedcolor={selectedColor}>
                ...
                <div className="time field">
                    ...
                    {(touched.startHour && errors.startHour) ||
                        (touched.startMin && errors.startMin) ||
                        (touched.startAmPm && errors.startAmPm)}
                </div>
                ...
                <div id="location" className="field">
                    ...
                    <Field
                        name="eventLocation"
                        type="text"
                        placeholder="Ex: Johnson Family Residence"
                    />
                </div>
                ...
                <div className="guests field">
                    <label htmlFor="childGuest">
                        NUMBER OF GUESTS - CHILD *
                    </label>
...
const EventForm = withFormik({
    ...
    validationSchema: Yup.object().shape({
        ...
        budget: Yup.number("Budget must be a number").required(
            "Your budget is required"
        ),
...
export default connect(mapStateToProp, { addEvent, getEvents, updateEvent })(
    EventForm
);
